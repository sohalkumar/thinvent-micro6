...
// import akal_academy from "@/public/images/institutes/akal_academy.webp";
...
export default function ProblemsSection() {
  return (
    <MotionDiv
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="relative px-4 py-8 lg:px-lg-x lg:py-[3.75rem] overflow-x-hidden"
    >
      ...
      <div className="text-center my-[8rem] lg:mt-[3.75rem]">
      ...
      {/* <div className="hidden md:flex flex-wrap gap-5 justify-center">
        <Image src={akal_academy} alt="Akal Academy" />
        <Image src={akal_academy} alt="Akal Academy" />
        <Image src={akal_academy} alt="Akal Academy" />
        <Image src={akal_academy} alt="Akal Academy" />
        <Image src={akal_academy} alt="Akal Academy" />
